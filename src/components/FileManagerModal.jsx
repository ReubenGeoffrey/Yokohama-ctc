    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-slate-950/70 backdrop-blur-sm">
        <motion.div
          ...
          className="bg-white rounded-2xl max-w-4xl w-full shadow-2xl border border-slate-200 relative z-50 overflow-hidden flex flex-col"
          style={{ maxHeight: '94vh' }}
        >
          {/* ── Top Header ───────────────────────────── */}
          <div className="p-5 sm:px-7 border-b border-slate-200 flex items-center justify-between bg-white flex-shrink-0">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 font-medium">
                  Select any month or date to inspect shift headcount, wages, and download workbooks.
                </p>
              </div>
            </div>
                      ...
                      <div className="pt-2 flex gap-2">
                        {selectedDayItem.result && (
                          <button
                            ...
                            className="flex-1 py-2.5 px-4 bg-blue-600 hover:bg-blue-700 text-white rounded-xl text-xs font-bold shadow-xs transition flex items-center justify-center space-x-1.5 cursor-pointer"
                          >
                        ...
                        <button
                          ...
                          className="px-3 py-2.5 rounded-xl bg-rose-50 hover:bg-rose-100 text-rose-600 hover:text-rose-800 border border-rose-200 transition cursor-pointer flex items-center justify-center"
                  ...
                  <div className="p-5 rounded-2xl bg-white border border-slate-200 shadow-xs space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <button
                        ...
                        className="py-2.5 px-3 bg-blue-600 hover:bg-blue-700 text-white rounded-xl text-xs font-bold shadow-xs transition flex items-center justify-center space-x-1.5 cursor-pointer disabled:opacity-50"
                      >
                      ...
                      <button
                        ...
                        className="py-2.5 px-3 bg-white hover:bg-slate-50 text-slate-800 border border-slate-200 rounded-xl text-xs font-bold shadow-2xs transition flex items-center justify-center space-x-1.5 cursor-pointer disabled:opacity-50"
                      >
